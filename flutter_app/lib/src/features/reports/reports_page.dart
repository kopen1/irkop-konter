...
class _ReportsPageState extends State<ReportsPage>{
 ...
 Row(children:[Expanded(child:_Metric(label:'Omzet',value:money.format(revenue),icon:Icons.payments_outlined)),const SizedBox(width:10),Expanded(child:_Metric(label:'Transaksi',value:all.length.toString(),icon:Icons.receipt_long_outlined))]),const SizedBox(height:10),_Metric(label:'Rata-rata transaksi',value:money.format(average),icon:Icons.trending_up_outlined),const SizedBox(height:20),
