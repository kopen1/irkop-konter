...
class TransactionRepository {
  ...
  Future<TransactionSummary> createManualTransaction({required String businessId,String? outletId,required double total,required String paymentMethod,required DateTime transactionAt,String? notes}) async {
