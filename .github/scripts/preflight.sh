...
for token in   "irkop_cell_outlets"   "irkop_cell_devices"   "irkop_cell_credit_payments"   "irkop_cell_product_stock_movements"   "irkop_cell_audit_logs" "irkop_cell_credit_balances"; do
